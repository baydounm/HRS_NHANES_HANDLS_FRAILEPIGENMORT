...
capture log using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\OUTPUT\HANDLS_HEATMAPCOX.smcl",replace
...
bysort zHorvathAgeEAA_no_outlierstert: su HorvathAgeEAA_no_outliers if sample_final==1
bysort zHannumAgeEAA_no_outlierstert: su HannumAgeEAA_no_outliers if sample_final==1
bysort zDunedinPoAm_no_outlierstert: su DunedinPoAm_no_outliers if sample_final==1
bysort zsestert: su zses if sample_final==1
