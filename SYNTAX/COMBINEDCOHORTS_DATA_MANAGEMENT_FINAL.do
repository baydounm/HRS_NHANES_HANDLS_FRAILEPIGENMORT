...
gen COHORT_COMP21=.
replace COHORT_COMP21=0 if COHORT1==1
replace COHORT_COMP21=1 if COHORT2==1


tab COHORT_COMP21


svy, subpop(COHORT_COMP21): reg AGE i.COHORT_COMP21
svy, subpop(COHORT_COMP21): mlogit SEX i.COHORT_COMP21
svy, subpop(COHORT_COMP21): mlogit RACE i.COHORT_COMP21
svy, subpop(COHORT_COMP21): mlogit frailty_status i.COHORT_COMP21
...
gen COHORT_COMP31=.
replace COHORT_COMP31=0 if COHORT1==1
replace COHORT_COMP31=1 if COHORT3==1


tab COHORT_COMP31


svy, subpop(COHORT_COMP31): reg AGE i.COHORT_COMP31
svy, subpop(COHORT_COMP31): mlogit SEX i.COHORT_COMP31
svy, subpop(COHORT_COMP31): mlogit RACE i.COHORT_COMP31
svy, subpop(COHORT_COMP31): mlogit frailty_status i.COHORT_COMP31


foreach x of varlist zHorvathAgeEAA zHannumAgeEAA zses  {
	svy, subpop(COHORT_COMP31): reg `x' i.COHORT_COMP31

}

stcox i.COHORT_COMP31 
