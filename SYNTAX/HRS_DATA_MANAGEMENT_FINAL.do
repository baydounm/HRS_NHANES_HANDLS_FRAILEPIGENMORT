...
capture log close
capture log using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\OUTPUT\HRS\DATA_MANAGEMENT_HRS.smcl",replace

**STEP 0: OPEN FILES AND CREATE HHIDPN VARIABLE, SORT BY THIS VARIABLE**

cd "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS"
...
use "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\randhrs1992_2020v2_resp_tracker",clear

sort HHIDPN
capture drop _merge

save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\randhrs1992_2020v2_resp_tracker",replace


use "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\TELOMERESA_R",clear
...
merge HHIDPN using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\randhrs1992_2020v2_resp_tracker"
...
capture log using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\OUTPUT\HRS\HEI2015.smcl",replace

************************************************HEI 2015********************

**STEP A: RUN STATA SCRIPTS FOR LEGUMES:

use "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\HCNS13_R_NT",clear
save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\HEI2015", replace
...
use "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\HEI2015", clear
...
capture log close
capture log using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\OUTPUT\HRS\FRAILTY.smcl",replace

***************Step 0: Extract RAND file variables needed**********************
...
keep HHIDPN HHID PN r13agey_e  ragender r13bmi  r13vgactx r13mdactx r12agey_e   r12bmi r13walksa

su HHID

**    Variable |        Obs        Mean    Std. dev.       Min        Max
**-------------+---------------------------------------------------------
**        HHID |     46,850      310929    252815.4          1     959738
...
**    Variable |        Obs        Mean    Std. dev.       Min        Max
**-------------+---------------------------------------------------------
**          PN |     46,850    14.88907    7.343958         10         43

su HHIDPN

**    Variable |        Obs        Mean    Std. dev.       Min        Max
**-------------+---------------------------------------------------------
**      HHIDPN |     46,851    3.11e+07    2.53e+07        110   9.60e+07


save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\rand2016.dta",replace
 

********************************************************************************
* Step 1: Define directories and datasets

***********Physical measures, 2016*********

use "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\HRS\H16I_R",clear
...
**    Variable |        Obs        Mean    Std. dev.       Min        Max
**-------------+---------------------------------------------------------
**        HHID |     20,912    386529.5    276018.4      10001     959738
...
**    Variable |        Obs        Mean    Std. dev.       Min        Max
**-------------+---------------------------------------------------------
**          PN |     20,912    14.94606    7.209694         10         43

su HHIDPN

**   Variable |        Obs        Mean    Std. dev.       Min        Max
**-------------+---------------------------------------------------------
**      HHIDPN |     20,912    3.87e+07    2.76e+07    1000110   9.60e+07

codebook

****Hand Grip strength: Average of right/left, first and second trial****

keep HHIDPN HHID PN PI816 PI851  PI852  PI853  

capture drop pm16gripmax
foreach var in PI816 PI851 PI852 PI853 {
    replace `var' = . if inlist(`var', 993, 998, 999)
}
egen pm16gripmax = rowmean(PI816 PI851 PI852 PI853)


su pm16gripmax
histogram pm16gripmax


**HAND STRENGTH VARIABLES:  PI816 PI851  PI852  PI853  (TAKE AVERAGE FOR L/R HAND, FIRST/SECOND TRIAL)
sort HHIDPN

save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\pm16.dta",replace



**https://hrs.isr.umich.edu/sites/default/files/meta/2016/core/codebook/h16lb_ri.htm**

use "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\HRS\H16LB_R",clear
...
**PLB018G: Corresponds to "I felt that everything I did was an effort." (18G: IMPOSSIBLE TO REACH GOALS)
***PLB018J: Corresponds to "I could not get going."​ ( 18J: NO USE IN TRYING TO GET SOMETHING)

tab1 PLB018G PLB018J, miss
...
capture drop r13cesd4
gen r13cesd4=.
replace r13cesd4=1 if PLB018G>=4 & PLB018G~=.
replace r13cesd4=0 if r13cesd4~=1 & PLB018G~=.

tab r13cesd4

capture drop r13cesd6
gen r13cesd6=.
replace r13cesd6=1 if PLB018J>=4 & PLB018J~=.
replace r13cesd6=0 if r13cesd6~=1 & PLB018J~=.
...
keep HHIDPN  HHID PN cycle PLB018G PLB018J r13cesd4 r13cesd6

save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\ces2016.dta",replace


********************************************************************************
global rand_file "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\rand2016.dta"
global pm_file   "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\pm16.dta"
global ces_file   "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\ces2016.dta"
global output_folder "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\"




********************************************************************************
* Step 2: Load RAND and PM 2016 files
********************************************************************************
* Load RAND file
use "$rand_file", clear

save $rand_file, replace

* If you have date variables for BMI measures (e.g., date14 and date16)
capture drop time_years
gen time_years = (r13agey_e-r12agey_e) 
gen delta_bmi_annual = (r12bmi - r13bmi) / time_years

* Apply the annual threshold: assuming 175 cm average height, 10 lb loss per year
capture drop weightloss
gen weightloss = .
replace weightloss = 1 if delta_bmi_annual >=1.48 & r12bmi~=. & r13bmi~=.
replace weightloss = 0 if delta_bmi_annual < 1.48 & r12bmi~=. & r13bmi~=.

tab weightloss

capture drop underweight
gen underweight=.
replace underweight=1 if r13bmi<18.5 & r13bmi~=.
replace underweight=0 if underweight~=1 & r13bmi~=.

tab underweight


****Difficulty walking several blocks: Proxy for walking speed***
tab r13walksa

**      r13walksa:w13 r any |
**     diff-walk sev blocks |      Freq.     Percent        Cum.
**--------------------------+-----------------------------------
**                     0.no |     13,593       68.04       68.04
**                    1.yes |      6,386       31.96      100.00
**--------------------------+-----------------------------------
**                    Total |     19,979      100.00

capture drop r13walkspeed
gen r13walkspeed=r13walksa
...
**     r13vgactx:w13 r freq |
**      vigorous phys activ |
**            {finer scale} |      Freq.     Percent        Cum.
**--------------------------+-----------------------------------
**              1.every day |        478        2.38        2.38
**            2.>1 per week |      4,362       21.76       24.14
**             3.1 per week |      2,139       10.67       34.81
**            4.l-3 per mon |      1,963        9.79       44.61
**                  5.never |     11,104       55.39      100.00
**--------------------------+-----------------------------------
**                    Total |     20,046      100.00

tab r13mdactx

**    r13mdactx:w13 r freq |
**      moderate phys activ |
**            {finer scale} |      Freq.     Percent        Cum.
**--------------------------+-----------------------------------
**              1.every day |      1,619        7.77        7.77
**            2.>1 per week |      8,444       40.54       48.31
**             3.1 per week |      3,672       17.63       65.94
**            4.l-3 per mon |      2,569       12.33       78.27
**                  5.never |      4,526       21.73      100.00
**--------------------------+-----------------------------------
**                    Total |     20,830      100.00
...
global rand_file_small "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\rand2016.dta"



*Load small RAND file**
use $rand_file_small,clear
capture drop HHIDPN
egen HHIDPN = concat(HHID PN)
keep if HHIDPN~=".."
destring HHIDPN, replace
sort HHIDPN
save $rand_file_small, replace



* Load 2016 Physical Measures
use "$pm_file", clear
destring HHIDPN,replace
sort HHIDPN
save $pm_file, replace

*Load  2016 CES-D scores**/

use "$ces_file", clear
sort HHIDPN
destring HHIDPN,replace
sort HHIDPN
save $ces_file, replace




********************************************************************************
* Step 3: Merge RAND WITH CES and PM files
********************************************************************************
use $rand_file_small,clear
destring HHIDPN, replace
sort HHIDPN
...
use $rand_file_small, clear
capture drop _merge 
merge HHIDPN using $pm_file
sort HHIDPN
tab _merge
capture drop _merge
merge HHIDPN using $ces_file
tab _merge
...
save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\FRAILTY_MERGEED_FILE_HRS", replace

********************************************************************************
* Step 4: Define Fried Frailty Components
********************************************************************************
* 1. Shrinking: unintentional weight loss >10 lbs
capture drop shrinking
gen shrinking =.
replace shrinking=1 if weightloss == 1 | underweight==1
replace shrinking=0 if shrinking~=1 & weightloss~=. & underweight~=.
 
tab shrinking

* 2. Weakness: low grip strength (sex-specific)

capture drop female
gen female = (ragender == 2)


tab pm16gripmax if female==0
**find 20th percentile**
capture drop male20
gen male20 =  27.125

tab pm16gripmax if female==1
**find 20th percentile**
capture drop female20
gen female20 = 16.625

capture drop weakness
gen weakness = .
replace weakness = 1 if (female==0 & pm16gripmax <= male20)
replace weakness = 1 if (female==1 & pm16gripmax <= female20)
replace weakness = 0 if weakness~=1 & pm16gripmax~=.

tab weakness

* 3. Slowness: low walking speed
capture drop slowness
gen slowness = ( r13walkspeed ==1)

tab slowness

* 4. Exhaustion: using CES-D fatigue items
capture drop exhaustion
gen exhaustion =.
replace exhaustion=1 if r13cesd4==1 & r13cesd4~=. | r13cesd6==1 & r13cesd6~=.
replace exhaustion=0 if exhaustion~=1 &  r13cesd4~=. & r13cesd6~=.

tab exhaustion

* 5. Low physical activity: low vigorous activity
capture drop low_pa
gen low_pa =.
replace low_pa=1 if r13vgactx >= 4 & r13vgactx~=.  | r13mdactx>=4 &  r13mdactx~=. // 4=1-3x/month or 5=hardly ever/never
replace low_pa=0 if low_pa~=1 & r13vgactx~=. & r13mdactx~=.

tab low_pa

********************************************************************************
* Step 5: Calculate Fried Frailty Score
********************************************************************************
capture drop fried_sum
capture drop fried_status

gen fried_sum = shrinking+weakness+slowness+exhaustion+low_pa

gen fried_status = .
replace fried_status = 0 if fried_sum == 0 
replace fried_status = 1 if inlist(fried_sum,1,2) 
replace fried_status = 2 if fried_sum >= 3 & fried_sum~=.

capture label drop friedlbl
label define friedlbl 0 "Robust" 1 "Pre-frail" 2 "Frail"
label values fried_status friedlbl
...
********************************************************************************
save "$output_folder/hrs2016_friedfrailty_final.dta", replace

capture drop ragender r12agey_e r13agey_e r13vgactx r13mdactx r12bmi  r13bmi r13walksa

save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\HRS_FRAILTY.dta", replace

capture log close
capture log using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\OUTPUT\HRS\MERGING_CODE.smcl",replace
...
capture drop _merge
save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\EPICLOCKA_R.dta",replace
...
sort HHIDPN
capture drop _merge
save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\HRS_FRAILTY",replace
...
merge HHIDPN using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\EPICLOCKA_R.dta"
tab _merge
capture drop _merge
sort HHIDPN
merge HHIDPN using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\HEI2015"
tab _merge
capture drop _merge
sort HHIDPN
merge HHIDPN using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\HRS_FRAILTY"
tab _merge
capture drop _merge
sort HHIDPN
...
capture log close
capture log using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\OUTPUT\HRS\FIGURES1_HRS_PARTICIPANTFLOWCHART.smcl",replace
...
gen sample50plus2016=.
replace sample50plus2016=1 if r13agey_e>=50 & r13agey_e~=.
replace sample50plus2016=0 if sample50plus2016~=1 & r13agey_e~=.
...
gen sample2=.
replace sample2=1 if sample50plus2016==1 & samplealivein2016==1
...
gen sample3=.
replace sample3=1 if sample2==1 & fried_sum~=.
...
gen sample6=.
replace sample6=1 if sample5==1 & fried_sum~=.
replace sample6=0 if sample6~=1
...
foreach var of varlist HORVATH_DNAMAGE_no_outliers HANNUM_DNAMAGE_no_outliers LEVINE_DNAMAGE_no_outliers DNAMGRIMAGE_no_outliers MPOA_no_outliers {
	histogram `var'
	graph save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FIGURES\HRS_EPIGENETIC\HRS_HIST`var'.gph",replace
...
foreach var of varlist HORVATH_DNAMAGE_no_outliers HANNUM_DNAMAGE_no_outliers LEVINE_DNAMAGE_no_outliers DNAMGRIMAGE_no_outliers {
	...
	histogram `var'EAA
	graph save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FIGURES\HRS_EPIGENETIC\HRS_HIST`var'EAA.gph", replace
	su `var'EAA
}

su  MPOA_no_outliers
histogram MPOA_no_outliers
graph save  "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FIGURES\HRS_EPIGENETIC\HRS_HISTDunedinPoAmEAA.gph", replace
...
capture drop zfried_sum
capture drop zses
foreach var of varlist HORVATH_DNAMAGE_no_outliersEAA HANNUM_DNAMAGE_no_outliersEAA LEVINE_DNAMAGE_no_outliersEAA DNAMGRIMAGE_no_outliersEAA MPOA_no_outliers  fried_sum ses {
...
gen frail_status=.
replace frail_status=1 if fried_status==2
replace frail_status=0 if fried_status==0 | fried_status==1 
...
capture log close
capture log using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\OUTPUT\HRS\HRS_KAPLANMEIERCURVES.smcl",replace
...
foreach var of varlist *tert frail_status {
	sts test `var' if sample_final==1  
}


foreach var of varlist *tert frail_status {
	sts graph if sample_final==1 & _t<7 , by(`var')
graph save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FIGURES\HRS_FIGURE1_KM\FIGURE1`var'.gph",replace
} 

graph combine "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FIGURES\HRS_FIGURE1_KM\FIGURE1zHorvathAgeEAAtert.gph" ///
"E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FIGURES\HRS_FIGURE1_KM\FIGURE1zDunedinPoAmtert.gph" ////
"E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FIGURES\HRS_FIGURE1_KM\FIGURE1zGrimAgeMortEAAtert.gph"  ///
"E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FIGURES\HRS_FIGURE1_KM\FIGURE1zHannumAgeEAAtert.gph"  ///
"E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FIGURES\HRS_FIGURE1_KM\FIGURE1zPhenoAgeEAAtert.gph"  ///
"E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FIGURES\HRS_FIGURE1_KM\FIGURE1frail_status.gph"  ///
"E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FIGURES\HRS_FIGURE1_KM\FIGURE1zsestert.gph"  ///


graph save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FIGURES\HRS_FIGURE1_KM\FIGURE1combined.gph",replace
...
capture log close
capture log using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\OUTPUT\HRS\HRS_CORRELATIONS_EPIGENEITC_FRIED.smcl",replace
...
**change name from fried_sum to frailty_score in revised excel sheet
...
## ------------------------------------------------------------
hrs_data_path <- "E://16GBBACKUPUSB//BACKUP_USB_SEPTEMBER2014//SUMMER_STUDENT_2025//HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT//FINAL_DATA//HRS//"

hrs_corr_file <- "E://16GBBACKUPUSB//BACKUP_USB_SEPTEMBER2014//SUMMER_STUDENT_2025//HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT//OUTPUT//HRS//HRS_correlation_matrix_final.csv"

## ------------------------------------------------------------
## 2) Load HRS analytic dataset (for density plot)
## ------------------------------------------------------------
## CHANGE the filename below to match your actual file in FINAL_DATA/HRS
df <- read_dta(file.path(hrs_data_path, "HRS_TLHEIFRAILEPIGENMORTfin_SMALL.dta"))

plot_df <- df %>%
  transmute(frailty_score = as.numeric(fried_sum)) %>%
...
p_density <- ggplot(plot_df, aes(x = frailty_score)) +
  ...
  labs(
    ...
    title = "Kernel-smoothed distribution of frailty score (HRS)"
  ) +
  theme_classic()
...
## ------------------------------------------------------------
# ggsave(
#   filename = "E://16GBBACKUPUSB//BACKUP_USB_SEPTEMBER2014//SUMMER_STUDENT_2025//HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT//OUTPUT//HRS//HRS_density_plus_heatmap.png",
#   plot = combined_plot,
#   width = 11,
#   height = 13,
#   dpi = 300
...
capture log using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\OUTPUT\HRS_HEATMAPCOX.txt", text replace
...
save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\HRS_TLHEIFRAILEPIGENMORTfin",replace
...
* Model 1*
foreach x of varlist zHorvathAgeEAA zHannumAgeEAA zPhenoAgeEAA zGrimAgeMortEAA zDunedinPoAm frail_status zses { 
...
capture esttab using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\results_TABLE5_MODEL1.csv", replace se ar2

capture clear
import delimited "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\results_TABLE5_MODEL1.csv",clear


* Convert the CSV file to a Stata dataset (if needed)
save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\results_TABLE5_MODEL1.dta",replace
...
foreach x of varlist zHorvathAgeEAA zHannumAgeEAA zPhenoAgeEAA zGrimAgeMortEAA zDunedinPoAm  { 
        ...
        * Run the stcox command
        stcox `x' AGE SEX i.RACE_ETHN ses frail_status if sample_final==1
...
* Export the results to a dataset
capture esttab using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\results_TABLE5_MODEL2.csv", replace se ar2

capture clear
import delimited "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\results_TABLE5_MODEL2.csv",clear


* Convert the CSV file to a Stata dataset (if needed)
save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\results_TABLE5_MODEL2.dta",replace
...
foreach x of varlist zHorvathAgeEAA zHannumAgeEAA zPhenoAgeEAA zGrimAgeMortEAA zDunedinPoAm frail_status zses { 
        ...
        * Run the stcox command
        stcox `x' AGE SEX i.RACE_ETHN AGESQ if sample_final==1
...
* Export the results to a dataset
capture esttab using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\results_TABLE5_MODEL1_SENS.csv", replace se ar2

capture clear
import delimited "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\results_TABLE5_MODEL1_SENS.csv",clear


* Convert the CSV file to a Stata dataset (if needed)
save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\results_TABLE5_MODEL1_SENS.dta",replace
...
foreach x of varlist zHorvathAgeEAA zHannumAgeEAA zPhenoAgeEAA zGrimAgeMortEAA zDunedinPoAm  { 
        ...
        * Run the stcox command
        stcox `x' AGE SEX i.RACE_ETHN ses frail_status AGESQ if sample_final==1
...
* Export the results to a dataset
capture esttab using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\results_TABLE5_MODEL2_SENS.csv", replace se ar2

capture clear
import delimited "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\results_TABLE5_MODEL2_SENS.csv",clear


* Convert the CSV file to a Stata dataset (if needed)
save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\results_TABLE5_MODEL2_SENS.dta",replace
...
**# Read the dataset
**data <- read.csv("E:/16GBBACKUPUSB/BACKUP_USB_SEPTEMBER2014/SUMMER_STUDENT_2025/HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT/FINAL_DATA/HRS/cleaned_results_TABLE5_MODEL1.csv")
...
//STEP 16: DISCRETIZE VARIABLES FOR ABN ANALYSIS AND GENERATE DATASET FOR R; CREATE A VARIABLE COHORT=2 (HRS)//
...
keep HHIDPN  AGE SEX RACE_ETHN zHorvathAgeEAA zHannumAgeEAA zPhenoAgeEAA zGrimAgeMortEAA zDunedinPoAm frail_status  _st _d _t _t0 COHORT zses

save "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\FINAL_DATA\HRS\HRS_TLHEIFRAILEPIGENMORT_ABN",replace
...
keep HHIDPN AGE SEX NHB HISP OTHER zHorvathAgeEAA zHannumAgeEAA zPhenoAgeEAA zGrimAgeMortEAA zDunedinPoAm frail_status   _d _st _d _t _t0 COHORT frail_status zses
...
capture log using "E:\16GBBACKUPUSB\BACKUP_USB_SEPTEMBER2014\SUMMER_STUDENT_2025\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\OUTPUT\HRS_DISCRETE_TIME_HAZARD_ABN.smcl",replace
...
BiocManager::install(c("graph", "Rgraphviz"), dep=TRUE, force=TRUE)
...
# Read the dataset
file_path <- "E:\\16GBBACKUPUSB\\BACKUP_USB_SEPTEMBER2014\\SUMMER_STUDENT_2025\\HRS_NHANES_HANDLS_FRAILTY_EPICLOCKS_MORT\\FINAL_DATA\\HRS\\HRS_TLHEIFRAILEPIGENMORT_ABN_DISCRETEfin.dta"
...
factorvars <- c("SEX", "d_var", "NHB", "HISP", "OTHER", "dummy1", "dummy2", "dummy3", "dummy4", "frail_status")
